import { Payment } from "./components/AnalyzedContacts/columns";

export function getOrder(id: string) {
  return getOrders().find((order : any) => order.id.toString() === id)!
}
...
export function getEventOrders(id: string) {
  return getOrders().filter((order : any) => order.event.id.toString() === id)
}



export function getOrders(): Payment[] {
  return [
    {
      id: "m5gr84i9",
      amount: 316,
